  ...
  <section class="relative w-full overflow-hidden py-16 sm:py-20 lg:py-24 border-b border-white/10">
    ...
    <div class="max-w-[1920px] mx-auto px-5 sm:px-10 lg:px-20 xl:px-28 relative z-10">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        >
          <span class="text-3xl sm:text-4xl font-light text-white mb-4 sm:mb-6 relative z-10">
            {{ card.num }}
          </span>
          ...
          <div class="absolute bottom-0 left-0 right-0 h-3/5 sm:h-1/2 bg-linear-to-t from-black/80 to-transparent z-0">
            <!-- Пример: <img :src="card.image" class="w-full h-full object-cover opacity-60 transition-opacity group-hover:opacity-100" /> -->
          </div>
        </div>
      </div>
    </div>
